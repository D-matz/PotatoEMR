...
from .FHIR_Resources.Account import *
from .FHIR_Resources.Availability import *
from .FHIR_Resources.Appointment import *
from .FHIR_Resources.Binary import *
...
from .FHIR_Resources.Communication import *
from .FHIR_Resources.Condition import *
from .FHIR_Resources.Device import *
from .FHIR_Resources.DeviceRequest import *
from .FHIR_Resources.DocumentReference import *
from .FHIR_Resources.DiagnosticReport import *
from .FHIR_Resources.Encounter import *
from .FHIR_Resources.Endpoint import *
from .FHIR_Resources.Event import *
from .FHIR_Resources.GenomicStudy import *
from .FHIR_Resources.Group import *
from .FHIR_Resources.HealthcareService import *
...
from .FHIR_Resources.RequestOrchestration import *
from .FHIR_Resources.ServiceRequest import *
from .FHIR_Resources.Slot import *
from .FHIR_Resources.Substance import *
from .FHIR_Resources.VirtualServiceDetail import *
from .FHIR_Resources.VisionPrescription import *
