...
class FHIR_DocumentReference_bodySite(models.Model):
    ...
    bodySite_BodyStructure_ref = models.ForeignKey("FHIR_BodyStructure", related_name="DocumentReference_bodySite", null=True, blank=True, on_delete=models.SET_NULL)
