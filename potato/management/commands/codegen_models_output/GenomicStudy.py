...
class FHIR_GenomicStudy_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="GenomicStudy_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="GenomicStudy_reason", null=True, blank=True, on_delete=models.SET_NULL)
