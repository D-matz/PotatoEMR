...
class FHIR_SearchParameter(models.Model):
    ...
    versionAlgorithm = models.OneToOneField("FHIR_GP_Coding", related_name='SearchParameter_versionAlgorithm', null=True, blank=True, on_delete=models.SET_NULL)
    ...
    class CodeChoices(models.TextChoices): RECOMMENDED_NAME_FOR_PARAMETER_IN_SEARCH_URL = 'Recommended name for parameter in search url', 'Recommended name for parameter in search url'; 
...
class FHIR_SearchParameter_aliasCode(models.Model):
    ...
    class AliascodeChoices(models.TextChoices): ADDITIONAL_RECOMMENDED_NAMES_FOR_PARAMETER_IN_SEARCH_URL = 'Additional recommended names for parameter in search url', 'Additional recommended names for parameter in search url'; 
...
class FHIR_SearchParameter_base(models.Model):
    ...
    class BaseChoices(models.TextChoices): THE_RESOURCE_TYPES_THIS_SEARCH_PARAMETER_APPLIES_TO = 'The resource type(s) this search parameter applies to', 'The resource type(s) this search parameter applies to'; 
...
class FHIR_SearchParameter_target(models.Model):
    ...
    class TargetChoices(models.TextChoices): TYPES_OF_RESOURCE_IF_A_RESOURCE_REFERENCE = 'Types of resource (if a resource reference)', 'Types of resource (if a resource reference)'; 
