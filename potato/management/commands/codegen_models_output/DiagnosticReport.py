...
class FHIR_DiagnosticReport_conclusionCode(models.Model):
    ...
    conclusionCode_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="DiagnosticReport_conclusionCode", null=True, blank=True, on_delete=models.SET_NULL)
    conclusionCode_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="DiagnosticReport_conclusionCode", null=True, blank=True, on_delete=models.SET_NULL)
