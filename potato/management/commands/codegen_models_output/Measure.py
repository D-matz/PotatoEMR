...
class FHIR_Measure(models.Model):
    ...
    class BasisChoices(models.TextChoices): POPULATION_BASIS_DEPRECATED,_USE_GROUP.BASIS = 'Population basis (deprecated, use group.basis)', 'Population basis (deprecated, use group.basis)'; 
...
class FHIR_Measure_group(models.Model):
    ...
    class BasisChoices(models.TextChoices): POPULATION_BASIS = 'Population basis', 'Population basis'; 
    basis = FHIR_primitive_CodeField(choices=BasisChoices.choices, null=True, blank=True, )
    BINDING_scoring = 'TODO'
