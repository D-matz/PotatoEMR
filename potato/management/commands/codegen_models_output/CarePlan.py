...
class FHIR_CarePlan_addresses(models.Model):
    ...
    addresses_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="CarePlan_addresses", null=True, blank=True, on_delete=models.SET_NULL)
    addresses_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="CarePlan_addresses", null=True, blank=True, on_delete=models.SET_NULL)
    addresses_MedicationAdministration_ref = models.ForeignKey("FHIR_MedicationAdministration", related_name="CarePlan_addresses", null=True, blank=True, on_delete=models.SET_NULL)
