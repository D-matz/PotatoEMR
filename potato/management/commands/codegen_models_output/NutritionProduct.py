...
class FHIR_NutritionProduct_nutrient(models.Model):
    ...
    item_SubstanceDefinition_ref = models.ForeignKey("FHIR_SubstanceDefinition", related_name="NutritionProduct_nutrient_item", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_NutritionProduct_ingredient(models.Model):
    ...
    item_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    item_NutritionProduct_ref = models.ForeignKey("FHIR_NutritionProduct", related_name="NutritionProduct_ingredient_item", null=True, blank=True, on_delete=models.SET_NULL)
