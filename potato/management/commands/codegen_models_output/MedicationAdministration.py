...
class FHIR_MedicationAdministration(models.Model):
    ...
    medication_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="MedicationAdministration_medication", null=True, blank=True, on_delete=models.SET_NULL)
    ...
    occurrence = models.OneToOneField("FHIR_GP_Period", related_name='MedicationAdministration_occurrence', null=True, blank=True, on_delete=models.SET_NULL)
    occurrence = models.OneToOneField("FHIR_GP_Timing", related_name='MedicationAdministration_occurrence', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_MedicationAdministration_performer(models.Model):
    ...
    actor_Practitioner_ref = models.ForeignKey("FHIR_Practitioner", related_name="MedicationAdministration_performer_actor", null=True, blank=True, on_delete=models.SET_NULL)
    actor_PractitionerRole_ref = models.ForeignKey("FHIR_PractitionerRole", related_name="MedicationAdministration_performer_actor", null=True, blank=True, on_delete=models.SET_NULL)
    actor_Patient_ref = models.ForeignKey("FHIR_Patient", related_name="MedicationAdministration_performer_actor", null=True, blank=True, on_delete=models.SET_NULL)
    actor_RelatedPerson_ref = models.ForeignKey("FHIR_RelatedPerson", related_name="MedicationAdministration_performer_actor", null=True, blank=True, on_delete=models.SET_NULL)
    actor_Device_ref = models.ForeignKey("FHIR_Device", related_name="MedicationAdministration_performer_actor", null=True, blank=True, on_delete=models.SET_NULL)
    actor_Group_ref = models.ForeignKey("FHIR_Group", related_name="MedicationAdministration_performer_actor", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_MedicationAdministration_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="MedicationAdministration_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="MedicationAdministration_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="MedicationAdministration_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="MedicationAdministration_reason", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_MedicationAdministration_device(models.Model):
    ...
    device_Device_ref = models.ForeignKey("FHIR_Device", related_name="MedicationAdministration_device", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_MedicationAdministration_dosage(models.Model):
    ...
    rate = models.OneToOneField("FHIR_GP_Ratio", related_name='MedicationAdministration_dosage_rate', null=True, blank=True, on_delete=models.SET_NULL)
    rate = models.OneToOneField("FHIR_GP_Quantity", related_name='MedicationAdministration_dosage_rate', null=True, blank=True, on_delete=models.SET_NULL)
