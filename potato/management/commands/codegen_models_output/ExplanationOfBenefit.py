...
class FHIR_ExplanationOfBenefit_item_bodySite_site(models.Model):
    ...
    site_BodyStructure_ref = models.ForeignKey("FHIR_BodyStructure", related_name="ExplanationOfBenefit_item_bodySite_site", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ExplanationOfBenefit_addItem_bodySite_site(models.Model):
    ...
    site_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    site_BodyStructure_ref = models.ForeignKey("FHIR_BodyStructure", related_name="ExplanationOfBenefit_addItem_bodySite_site", null=True, blank=True, on_delete=models.SET_NULL)
