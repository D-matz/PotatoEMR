...
class FHIR_RequestOrchestration_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="RequestOrchestration_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="RequestOrchestration_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="RequestOrchestration_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="RequestOrchestration_reason", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_RequestOrchestration_action(models.Model):
    ...
    location_Location_ref = models.ForeignKey("FHIR_Location", related_name="RequestOrchestration_action_location", null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_type = 'TODO'
