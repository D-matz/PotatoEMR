...
class FHIR_BodyStructure_includedStructure_bodyLandmarkOrientation_distanceFromLandmark_device(models.Model):
    ...
    device_Device_ref = models.ForeignKey("FHIR_Device", related_name="BodyStructure_includedStructure_bodyLandmarkOrientation_distanceFromLandmark_device", null=True, blank=True, on_delete=models.SET_NULL)
