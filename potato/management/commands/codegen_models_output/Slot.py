...
class FHIR_Slot_serviceType(models.Model):
    ...
    serviceType_HealthcareService_ref = models.ForeignKey("FHIR_HealthcareService", related_name="Slot_serviceType", null=True, blank=True, on_delete=models.SET_NULL)
