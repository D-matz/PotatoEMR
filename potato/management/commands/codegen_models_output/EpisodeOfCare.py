...
class FHIR_EpisodeOfCare_reason_value(models.Model):
    ...
    value_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="EpisodeOfCare_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
    value_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="EpisodeOfCare_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
    value_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="EpisodeOfCare_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
    value_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="EpisodeOfCare_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
    value_HealthcareService_ref = models.ForeignKey("FHIR_HealthcareService", related_name="EpisodeOfCare_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_EpisodeOfCare_diagnosis_condition(models.Model):
    ...
    condition_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="EpisodeOfCare_diagnosis_condition", null=True, blank=True, on_delete=models.SET_NULL)
