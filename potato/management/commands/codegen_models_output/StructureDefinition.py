...
class FHIR_StructureDefinition(models.Model):
    ...
    class FhirversionChoices(models.TextChoices): FHIR_VERSION_THIS_STRUCTUREDEFINITION_TARGETS = 'FHIR Version this StructureDefinition targets', 'Fhir version this structuredefinition targets'; 
