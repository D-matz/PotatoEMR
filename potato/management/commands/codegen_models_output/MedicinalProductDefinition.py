...
class FHIR_MedicinalProductDefinition_impurity(models.Model):
    ...
    impurity_SubstanceDefinition_ref = models.ForeignKey("FHIR_SubstanceDefinition", related_name="MedicinalProductDefinition_impurity", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_MedicinalProductDefinition_crossReference(models.Model):
    ...
    product_MedicinalProductDefinition_ref = models.ForeignKey("FHIR_MedicinalProductDefinition", related_name="MedicinalProductDefinition_crossReference_product", null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_type = 'TODO'
...
class FHIR_MedicinalProductDefinition_operation(models.Model):
    ...
    type_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    type_ActivityDefinition_ref = models.ForeignKey("FHIR_ActivityDefinition", related_name="MedicinalProductDefinition_operation_type", null=True, blank=True, on_delete=models.SET_NULL)
    type_PlanDefinition_ref = models.ForeignKey("FHIR_PlanDefinition", related_name="MedicinalProductDefinition_operation_type", null=True, blank=True, on_delete=models.SET_NULL)
