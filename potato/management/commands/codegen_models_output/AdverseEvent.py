...
class FHIR_AdverseEvent_resultingEffect(models.Model):
    ...
    resultingEffect_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="AdverseEvent_resultingEffect", null=True, blank=True, on_delete=models.SET_NULL)
    resultingEffect_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="AdverseEvent_resultingEffect", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_AdverseEvent_suspectEntity(models.Model):
    ...
    instance_Immunization_ref = models.ForeignKey("FHIR_Immunization", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
    instance_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
    instance_Substance_ref = models.ForeignKey("FHIR_Substance", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
    instance_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
    instance_MedicationAdministration_ref = models.ForeignKey("FHIR_MedicationAdministration", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
    instance_MedicationStatement_ref = models.ForeignKey("FHIR_MedicationStatement", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
    instance_Device_ref = models.ForeignKey("FHIR_Device", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
    instance_BiologicallyDerivedProduct_ref = models.ForeignKey("FHIR_BiologicallyDerivedProduct", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
    instance_ResearchStudy_ref = models.ForeignKey("FHIR_ResearchStudy", related_name="AdverseEvent_suspectEntity_instance", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_AdverseEvent_contributingFactor(models.Model):
    ...
    contributingFactor_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_AllergyIntolerance_ref = models.ForeignKey("FHIR_AllergyIntolerance", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_FamilyMemberHistory_ref = models.ForeignKey("FHIR_FamilyMemberHistory", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_Immunization_ref = models.ForeignKey("FHIR_Immunization", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_Device_ref = models.ForeignKey("FHIR_Device", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_DeviceUsage_ref = models.ForeignKey("FHIR_DeviceUsage", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_MedicationAdministration_ref = models.ForeignKey("FHIR_MedicationAdministration", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
    contributingFactor_MedicationStatement_ref = models.ForeignKey("FHIR_MedicationStatement", related_name="AdverseEvent_contributingFactor", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_AdverseEvent_preventiveAction(models.Model):
    ...
    preventiveAction_Immunization_ref = models.ForeignKey("FHIR_Immunization", related_name="AdverseEvent_preventiveAction", null=True, blank=True, on_delete=models.SET_NULL)
    preventiveAction_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="AdverseEvent_preventiveAction", null=True, blank=True, on_delete=models.SET_NULL)
    preventiveAction_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="AdverseEvent_preventiveAction", null=True, blank=True, on_delete=models.SET_NULL)
    preventiveAction_MedicationAdministration_ref = models.ForeignKey("FHIR_MedicationAdministration", related_name="AdverseEvent_preventiveAction", null=True, blank=True, on_delete=models.SET_NULL)
    preventiveAction_MedicationRequest_ref = models.ForeignKey("FHIR_MedicationRequest", related_name="AdverseEvent_preventiveAction", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_AdverseEvent_mitigatingAction(models.Model):
    ...
    mitigatingAction_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="AdverseEvent_mitigatingAction", null=True, blank=True, on_delete=models.SET_NULL)
    mitigatingAction_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="AdverseEvent_mitigatingAction", null=True, blank=True, on_delete=models.SET_NULL)
    mitigatingAction_MedicationAdministration_ref = models.ForeignKey("FHIR_MedicationAdministration", related_name="AdverseEvent_mitigatingAction", null=True, blank=True, on_delete=models.SET_NULL)
    mitigatingAction_MedicationRequest_ref = models.ForeignKey("FHIR_MedicationRequest", related_name="AdverseEvent_mitigatingAction", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_AdverseEvent_supportingInfo(models.Model):
    ...
    supportingInfo_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_AllergyIntolerance_ref = models.ForeignKey("FHIR_AllergyIntolerance", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_FamilyMemberHistory_ref = models.ForeignKey("FHIR_FamilyMemberHistory", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_Immunization_ref = models.ForeignKey("FHIR_Immunization", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_MedicationAdministration_ref = models.ForeignKey("FHIR_MedicationAdministration", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_MedicationStatement_ref = models.ForeignKey("FHIR_MedicationStatement", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
    supportingInfo_QuestionnaireResponse_ref = models.ForeignKey("FHIR_QuestionnaireResponse", related_name="AdverseEvent_supportingInfo", null=True, blank=True, on_delete=models.SET_NULL)
