...
class FHIR_ChargeItem(models.Model):
    ...
    occurrence = models.OneToOneField("FHIR_GP_Period", related_name='ChargeItem_occurrence', null=True, blank=True, on_delete=models.SET_NULL)
    occurrence = models.OneToOneField("FHIR_GP_Timing", related_name='ChargeItem_occurrence', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ChargeItem_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="ChargeItem_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="ChargeItem_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="ChargeItem_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_ImmunizationRecommendation_ref = models.ForeignKey("FHIR_ImmunizationRecommendation", related_name="ChargeItem_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="ChargeItem_reason", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ChargeItem_service(models.Model):
    ...
    service_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_ImagingStudy_ref = models.ForeignKey("FHIR_ImagingStudy", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_Immunization_ref = models.ForeignKey("FHIR_Immunization", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_MedicationAdministration_ref = models.ForeignKey("FHIR_MedicationAdministration", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_MedicationDispense_ref = models.ForeignKey("FHIR_MedicationDispense", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_MedicationRequest_ref = models.ForeignKey("FHIR_MedicationRequest", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_ServiceRequest_ref = models.ForeignKey("FHIR_ServiceRequest", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
    service_SupplyDelivery_ref = models.ForeignKey("FHIR_SupplyDelivery", related_name="ChargeItem_service", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ChargeItem_product(models.Model):
    ...
    product_Device_ref = models.ForeignKey("FHIR_Device", related_name="ChargeItem_product", null=True, blank=True, on_delete=models.SET_NULL)
    product_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="ChargeItem_product", null=True, blank=True, on_delete=models.SET_NULL)
    product_Substance_ref = models.ForeignKey("FHIR_Substance", related_name="ChargeItem_product", null=True, blank=True, on_delete=models.SET_NULL)
