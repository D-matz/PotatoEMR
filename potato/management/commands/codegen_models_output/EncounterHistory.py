...
class FHIR_EncounterHistory_serviceType(models.Model):
    ...
    serviceType_HealthcareService_ref = models.ForeignKey("FHIR_HealthcareService", related_name="EncounterHistory_serviceType", null=True, blank=True, on_delete=models.SET_NULL)
