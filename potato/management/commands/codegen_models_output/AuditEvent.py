...
class FHIR_AuditEvent(models.Model):
    ...
    class ActionChoices(models.TextChoices): TYPE_OF_ACTION_PERFORMED_DURING_THE_EVENT = 'Type of action performed during the event', 'Type of action performed during the event'; 
    ...
    occurred = models.OneToOneField("FHIR_GP_Period", related_name='AuditEvent_occurred', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_AuditEvent_agent(models.Model):
    ...
    network = models.ForeignKey("FHIR_Endpoint", related_name="AuditEvent_agent_network", null=True, blank=True, on_delete=models.SET_NULL)
    network = FHIR_primitive_URIField(null=True, blank=True, )
...
class FHIR_AuditEvent_entity_detail(models.Model):
    ...
    type_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    value = models.OneToOneField("FHIR_GP_Quantity", related_name='AuditEvent_entity_detail_value', null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_value = 'TODO'
    value_cc = models.ManyToManyField(FHIR_GP_Coding, limit_choices_to={"codings__binding_rule": BINDING_value}, related_name='AuditEvent_entity_detail_value', blank=True)
    ...
    value = models.OneToOneField("FHIR_GP_Range", related_name='AuditEvent_entity_detail_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Ratio", related_name='AuditEvent_entity_detail_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = FHIR_primitive_TimeField(null=True, blank=True, )
    value = FHIR_primitive_DateTimeField(null=True, blank=True, )
    value = models.OneToOneField("FHIR_GP_Period", related_name='AuditEvent_entity_detail_value', null=True, blank=True, on_delete=models.SET_NULL)
