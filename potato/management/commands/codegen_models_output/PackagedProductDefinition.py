...
class FHIR_PackagedProductDefinition_packaging_containedItem(models.Model):
    ...
    item_ManufacturedItemDefinition_ref = models.ForeignKey("FHIR_ManufacturedItemDefinition", related_name="PackagedProductDefinition_packaging_containedItem_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="PackagedProductDefinition_packaging_containedItem_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_PackagedProductDefinition_ref = models.ForeignKey("FHIR_PackagedProductDefinition", related_name="PackagedProductDefinition_packaging_containedItem_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_BiologicallyDerivedProduct_ref = models.ForeignKey("FHIR_BiologicallyDerivedProduct", related_name="PackagedProductDefinition_packaging_containedItem_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_NutritionProduct_ref = models.ForeignKey("FHIR_NutritionProduct", related_name="PackagedProductDefinition_packaging_containedItem_item", null=True, blank=True, on_delete=models.SET_NULL)
