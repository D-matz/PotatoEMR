...
class FHIR_Transport_input(models.Model):
    ...
    class ValueChoices(models.TextChoices): CONTENT_TO_USE_IN_PERFORMING_THE_TRANSPORT = 'Content to use in performing the transport', 'Content to use in performing the transport'; 
    ...
    value = models.OneToOneField("FHIR_GP_Address", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Annotation", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Attachment", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_value = 'TODO'
    value_cc = models.ManyToManyField(FHIR_GP_Coding, limit_choices_to={"codings__binding_rule": BINDING_value}, related_name='Transport_input_value', blank=True)
    value_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    value = models.OneToOneField("FHIR_GP_Coding", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_ContactPoint", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Distance", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Duration", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_HumanName", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Identifier", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Money", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Period", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Range", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Ratio", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_SampledData", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Signature", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Timing", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_meta_ExtendedContactDetail", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_SP_Dosage", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_SP_Meta", related_name='Transport_input_value', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Transport_output(models.Model):
    ...
    value = FHIR_primitive_URLField(null=True, blank=True, )
    value = FHIR_primitive_UUIDField(null=True, blank=True, )
    value = models.OneToOneField("FHIR_GP_Address", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Annotation", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Attachment", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_value = 'TODO'
    value_cc = models.ManyToManyField(FHIR_GP_Coding, limit_choices_to={"codings__binding_rule": BINDING_value}, related_name='Transport_output_value', blank=True)
    value_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    value = models.OneToOneField("FHIR_GP_Coding", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_ContactPoint", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Distance", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Duration", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_HumanName", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Identifier", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Money", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Period", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Range", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Ratio", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_SampledData", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Signature", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Timing", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_meta_ExtendedContactDetail", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_SP_Dosage", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_SP_Meta", related_name='Transport_output_value', null=True, blank=True, on_delete=models.SET_NULL)
