...
class FHIR_MedicationKnowledge_indicationGuideline_indication(models.Model):
    ...
    indication_ClinicalUseDefinition_ref = models.ForeignKey("FHIR_ClinicalUseDefinition", related_name="MedicationKnowledge_indicationGuideline_indication", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_MedicationKnowledge_definitional_ingredient(models.Model):
    ...
    item_Substance_ref = models.ForeignKey("FHIR_Substance", related_name="MedicationKnowledge_definitional_ingredient_item", null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_type = 'TODO'
