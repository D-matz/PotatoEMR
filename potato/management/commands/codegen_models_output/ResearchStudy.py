...
class FHIR_ResearchStudy_focus(models.Model):
    ...
    focus_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="ResearchStudy_focus", null=True, blank=True, on_delete=models.SET_NULL)
    focus_MedicinalProductDefinition_ref = models.ForeignKey("FHIR_MedicinalProductDefinition", related_name="ResearchStudy_focus", null=True, blank=True, on_delete=models.SET_NULL)
    focus_SubstanceDefinition_ref = models.ForeignKey("FHIR_SubstanceDefinition", related_name="ResearchStudy_focus", null=True, blank=True, on_delete=models.SET_NULL)
    focus_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="ResearchStudy_focus", null=True, blank=True, on_delete=models.SET_NULL)
    focus_PlanDefinition_ref = models.ForeignKey("FHIR_PlanDefinition", related_name="ResearchStudy_focus", null=True, blank=True, on_delete=models.SET_NULL)
