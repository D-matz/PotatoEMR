...
class FHIR_SupplyRequest(models.Model):
    class StatusChoices(models.TextChoices): DRAFT = 'draft', 'Draft'; ACTIVE = 'active', 'Active'; SUSPENDED_+ = 'suspended +', 'Suspended +'; 
    ...
    item_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="SupplyRequest_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_Substance_ref = models.ForeignKey("FHIR_Substance", related_name="SupplyRequest_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_Device_ref = models.ForeignKey("FHIR_Device", related_name="SupplyRequest_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="SupplyRequest_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_BiologicallyDerivedProduct_ref = models.ForeignKey("FHIR_BiologicallyDerivedProduct", related_name="SupplyRequest_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_NutritionProduct_ref = models.ForeignKey("FHIR_NutritionProduct", related_name="SupplyRequest_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_InventoryItem_ref = models.ForeignKey("FHIR_InventoryItem", related_name="SupplyRequest_item", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_SupplyRequest_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="SupplyRequest_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="SupplyRequest_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="SupplyRequest_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="SupplyRequest_reason", null=True, blank=True, on_delete=models.SET_NULL)
