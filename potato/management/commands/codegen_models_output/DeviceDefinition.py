...
class FHIR_DeviceDefinition_outputLanguage(models.Model):
    ...
    class OutputlanguageChoices(models.TextChoices): LANGUAGE_CODE_FOR_THE_HUMAN_READABLE_TEXT_STRINGS_PRODUCED_BY_THE_DEVICE_ALL_SUPPORTED = 'Language code for the human-readable text strings produced by the device (all supported)', 'Language code for the human-readable text strings produced by the device (all supported)'; 
...
class FHIR_DeviceDefinition_link(models.Model):
    ...
    relatedDevice_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="DeviceDefinition_link_relatedDevice", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_DeviceDefinition_chargeItem(models.Model):
    ...
    chargeItemCode_ChargeItemDefinition_ref = models.ForeignKey("FHIR_ChargeItemDefinition", related_name="DeviceDefinition_chargeItem_chargeItemCode", null=True, blank=True, on_delete=models.SET_NULL)
