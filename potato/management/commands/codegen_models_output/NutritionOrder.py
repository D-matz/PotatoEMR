...
class FHIR_NutritionOrder_performer(models.Model):
    ...
    performer_CareTeam_ref = models.ForeignKey("FHIR_CareTeam", related_name="NutritionOrder_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_Practitioner_ref = models.ForeignKey("FHIR_Practitioner", related_name="NutritionOrder_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_PractitionerRole_ref = models.ForeignKey("FHIR_PractitionerRole", related_name="NutritionOrder_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_RelatedPerson_ref = models.ForeignKey("FHIR_RelatedPerson", related_name="NutritionOrder_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_Patient_ref = models.ForeignKey("FHIR_Patient", related_name="NutritionOrder_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_Organization_ref = models.ForeignKey("FHIR_Organization", related_name="NutritionOrder_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_Group_ref = models.ForeignKey("FHIR_Group", related_name="NutritionOrder_performer", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_NutritionOrder_supplement(models.Model):
    ...
    type_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    type_NutritionProduct_ref = models.ForeignKey("FHIR_NutritionProduct", related_name="NutritionOrder_supplement_type", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_NutritionOrder_enteralFormula(models.Model):
    ...
    type_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    type_NutritionProduct_ref = models.ForeignKey("FHIR_NutritionProduct", related_name="NutritionOrder_enteralFormula_type", null=True, blank=True, on_delete=models.SET_NULL)
    productName = FHIR_primitive_StringField(null=True, blank=True, )
...
class FHIR_NutritionOrder_enteralFormula_deliveryDevice(models.Model):
    ...
    deliveryDevice_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="NutritionOrder_enteralFormula_deliveryDevice", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_NutritionOrder_additive(models.Model):
    ...
    modularType_NutritionProduct_ref = models.ForeignKey("FHIR_NutritionProduct", related_name="NutritionOrder_additive_modularType", null=True, blank=True, on_delete=models.SET_NULL)
    productName = FHIR_primitive_StringField(null=True, blank=True, )
