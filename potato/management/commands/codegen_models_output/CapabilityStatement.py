...
class FHIR_CapabilityStatement(models.Model):
    ...
    versionAlgorithm = models.OneToOneField("FHIR_GP_Coding", related_name='CapabilityStatement_versionAlgorithm', null=True, blank=True, on_delete=models.SET_NULL)
    ...
    class FhirversionChoices(models.TextChoices): FHIR_VERSION_THE_SYSTEM_SUPPORTS = 'FHIR Version the system supports', 'Fhir version the system supports'; 
...
class FHIR_CapabilityStatement_patchFormat(models.Model):
    ...
    class PatchformatChoices(models.TextChoices): PATCH_FORMATS_SUPPORTED_MIME_TYPES_FOR_FHIR_AND_JSON_AND_XML_PATCH = 'Patch formats supported (Mime types for FHIR and JSON And XML Patch)', 'Patch formats supported (mime types for fhir and json and xml patch)'; 
...
class FHIR_CapabilityStatement_acceptLanguage(models.Model):
    ...
    class AcceptlanguageChoices(models.TextChoices): LANGUAGES_SUPPORTED = 'Languages supported', 'Languages supported'; 
...
class FHIR_CapabilityStatement_rest_resource(models.Model):
    ...
    class TypeChoices(models.TextChoices): A_RESOURCE_TYPE_THAT_IS_SUPPORTED = 'A resource type that is supported', 'A resource type that is supported'; 
