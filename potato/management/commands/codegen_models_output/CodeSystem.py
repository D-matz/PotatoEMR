...
class FHIR_CodeSystem_filter(models.Model):
    ...
    class CodeChoices(models.TextChoices): CODE_THAT_IDENTIFIES_THE_FILTER = 'Code that identifies the filter', 'Code that identifies the filter'; 
...
class FHIR_CodeSystem_filter_operator(models.Model):
    ...
    class OperatorChoices(models.TextChoices): = = '=', '='; IS_A = 'is-a', 'Is-a'; DESCENDENT_OF = 'descendent-of', 'Descendent-of'; IS_NOT_A = 'is-not-a', 'Is-not-a'; REGEX = 'regex', 'Regex'; IN = 'in', 'In'; NOT_IN = 'not-in', 'Not-in'; GENERALIZES = 'generalizes', 'Generalizes'; CHILD_OF = 'child-of', 'Child-of'; DESCENDENT_LEAF = 'descendent-leaf', 'Descendent-leaf'; EXISTS = 'exists', 'Exists'; 
...
class FHIR_CodeSystem_concept(models.Model):
    ...
    class CodeChoices(models.TextChoices): CODE_THAT_IDENTIFIES_CONCEPT = 'Code that identifies concept', 'Code that identifies concept'; 
    code = FHIR_primitive_CodeField(choices=CodeChoices.choices, null=True, blank=True, )
...
class FHIR_CodeSystem_concept_property(models.Model):
    ...
    class CodeChoices(models.TextChoices): REFERENCE_TO_CODESYSTEM.PROPERTY.CODE = 'Reference to CodeSystem.property.code', 'Reference to codesystem.property.code'; 
    code = FHIR_primitive_CodeField(choices=CodeChoices.choices, null=True, blank=True, )
