...
class FHIR_ConceptMap_property(models.Model):
    ...
    class CodeChoices(models.TextChoices): IDENTIFIES_THE_PROPERTY_ON_THE_MAPPINGS,_AND_WHEN_REFERRED_TO_IN_THE_$TRANSLATE_OPERATION = 'Identifies the property on the mappings, and when referred to in the $translate operation', 'Identifies the property on the mappings, and when referred to in the $translate operation'; 
...
class FHIR_ConceptMap_additionalAttribute(models.Model):
    ...
    class CodeChoices(models.TextChoices): IDENTIFIES_THIS_ADDITIONAL_ATTRIBUTE_THROUGH_THIS_RESOURCE = 'Identifies this additional attribute through this resource', 'Identifies this additional attribute through this resource'; 
    code = FHIR_primitive_CodeField(choices=CodeChoices.choices, null=True, blank=True, )
    uri = FHIR_primitive_URIField(null=True, blank=True, )
    description = FHIR_primitive_StringField(null=True, blank=True, )
...
class FHIR_ConceptMap_group_element(models.Model):
    ...
    class CodeChoices(models.TextChoices): IDENTIFIES_ELEMENT_BEING_MAPPED = 'Identifies element being mapped', 'Identifies element being mapped'; 
    code = FHIR_primitive_CodeField(choices=CodeChoices.choices, null=True, blank=True, )
...
class FHIR_ConceptMap_group_element_target(models.Model):
    ...
    class CodeChoices(models.TextChoices): CODE_THAT_IDENTIFIES_THE_TARGET_ELEMENT = 'Code that identifies the target element', 'Code that identifies the target element'; 
    code = FHIR_primitive_CodeField(choices=CodeChoices.choices, null=True, blank=True, )
    display = FHIR_primitive_StringField(null=True, blank=True, )
    valueSet = FHIR_primitive_CanonicalField(null=True, blank=True, )
...
class FHIR_ConceptMap_group_element_target_property(models.Model):
    ...
    class CodeChoices(models.TextChoices): REFERENCE_TO_CONCEPTMAP.PROPERTY.CODE = 'Reference to ConceptMap.property.code', 'Reference to conceptmap.property.code'; 
    code = FHIR_primitive_CodeField(choices=CodeChoices.choices, null=True, blank=True, )
...
class FHIR_ConceptMap_group_element_target_dependsOn(models.Model):
    ...
    class AttributeChoices(models.TextChoices): A_REFERENCE_TO_A_MAPPING_ATTRIBUTE_DEFINED_IN_CONCEPTMAP.ADDITIONALATTRIBUTE = 'A reference to a mapping attribute defined in ConceptMap.additionalAttribute', 'A reference to a mapping attribute defined in conceptmap.additionalattribute'; 
    attribute = FHIR_primitive_CodeField(choices=AttributeChoices.choices, null=True, blank=True, )
    class ValueChoices(models.TextChoices): VALUE_OF_THE_REFERENCED_DATA_ELEMENT = 'Value of the referenced data element', 'Value of the referenced data element'; 
    value = FHIR_primitive_CodeField(choices=ValueChoices.choices, null=True, blank=True, )
...
class FHIR_ConceptMap_group_unmapped(models.Model):
    ...
    class CodeChoices(models.TextChoices): FIXED_CODE_WHEN_MODE_=_FIXED = 'Fixed code when mode = fixed', 'Fixed code when mode = fixed'; 
    code = FHIR_primitive_CodeField(choices=CodeChoices.choices, null=True, blank=True, )
    display = FHIR_primitive_StringField(null=True, blank=True, )
    valueSet = FHIR_primitive_CanonicalField(null=True, blank=True, )
    class RelationshipChoices(models.TextChoices): RELATED_TO = 'related-to', 'Related-to'; EQUIVALENT = 'equivalent', 'Equivalent'; SOURCE_IS_NARROWER_THAN_TARGET = 'source-is-narrower-than-target', 'Source-is-narrower-than-target'; SOURCE_IS_BROADER_THAN_TARGET = 'source-is-broader-than-target', 'Source-is-broader-than-target'; NOT_RELATED_TO = 'not-related-to', 'Not-related-to'; 
