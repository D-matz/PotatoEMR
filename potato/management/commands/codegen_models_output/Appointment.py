...
class FHIR_Appointment_serviceType(models.Model):
    ...
    serviceType_HealthcareService_ref = models.ForeignKey("FHIR_HealthcareService", related_name="Appointment_serviceType", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Appointment_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="Appointment_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="Appointment_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="Appointment_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="Appointment_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_ImmunizationRecommendation_ref = models.ForeignKey("FHIR_ImmunizationRecommendation", related_name="Appointment_reason", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Appointment_patientInstruction(models.Model):
    ...
    patientInstruction_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="Appointment_patientInstruction", null=True, blank=True, on_delete=models.SET_NULL)
    patientInstruction_Binary_ref = models.ForeignKey("FHIR_Binary", related_name="Appointment_patientInstruction", null=True, blank=True, on_delete=models.SET_NULL)
    patientInstruction_Communication_ref = models.ForeignKey("FHIR_Communication", related_name="Appointment_patientInstruction", null=True, blank=True, on_delete=models.SET_NULL)
