...
class FHIR_DeviceRequest(models.Model):
    ...
    code_Device_ref = models.ForeignKey("FHIR_Device", related_name="DeviceRequest_code", null=True, blank=True, on_delete=models.SET_NULL)
    code_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="DeviceRequest_code", null=True, blank=True, on_delete=models.SET_NULL)
    ...
    performer_Practitioner_ref = models.ForeignKey("FHIR_Practitioner", related_name="DeviceRequest_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_PractitionerRole_ref = models.ForeignKey("FHIR_PractitionerRole", related_name="DeviceRequest_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_Organization_ref = models.ForeignKey("FHIR_Organization", related_name="DeviceRequest_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_CareTeam_ref = models.ForeignKey("FHIR_CareTeam", related_name="DeviceRequest_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_HealthcareService_ref = models.ForeignKey("FHIR_HealthcareService", related_name="DeviceRequest_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_Patient_ref = models.ForeignKey("FHIR_Patient", related_name="DeviceRequest_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_Device_ref = models.ForeignKey("FHIR_Device", related_name="DeviceRequest_performer", null=True, blank=True, on_delete=models.SET_NULL)
    performer_RelatedPerson_ref = models.ForeignKey("FHIR_RelatedPerson", related_name="DeviceRequest_performer", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_DeviceRequest_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="DeviceRequest_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="DeviceRequest_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="DeviceRequest_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="DeviceRequest_reason", null=True, blank=True, on_delete=models.SET_NULL)
