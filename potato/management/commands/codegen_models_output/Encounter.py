...
class FHIR_Encounter_serviceType(models.Model):
    ...
    serviceType_HealthcareService_ref = models.ForeignKey("FHIR_HealthcareService", related_name="Encounter_serviceType", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Encounter_reason_value(models.Model):
    ...
    value_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="Encounter_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
    value_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="Encounter_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
    value_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="Encounter_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
    value_ImmunizationRecommendation_ref = models.ForeignKey("FHIR_ImmunizationRecommendation", related_name="Encounter_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
    value_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="Encounter_reason_value", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Encounter_diagnosis_condition(models.Model):
    ...
    condition_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="Encounter_diagnosis_condition", null=True, blank=True, on_delete=models.SET_NULL)
