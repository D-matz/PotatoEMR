...
class FHIR_InventoryReport_inventoryListing_item(models.Model):
    ...
    item_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="InventoryReport_inventoryListing_item_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_Device_ref = models.ForeignKey("FHIR_Device", related_name="InventoryReport_inventoryListing_item_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_NutritionProduct_ref = models.ForeignKey("FHIR_NutritionProduct", related_name="InventoryReport_inventoryListing_item_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_InventoryItem_ref = models.ForeignKey("FHIR_InventoryItem", related_name="InventoryReport_inventoryListing_item_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_BiologicallyDerivedProduct_ref = models.ForeignKey("FHIR_BiologicallyDerivedProduct", related_name="InventoryReport_inventoryListing_item_item", null=True, blank=True, on_delete=models.SET_NULL)
