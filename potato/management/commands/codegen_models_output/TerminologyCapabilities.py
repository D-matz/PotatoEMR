...
class FHIR_TerminologyCapabilities(models.Model):
    ...
    versionAlgorithm = models.OneToOneField("FHIR_GP_Coding", related_name='TerminologyCapabilities_versionAlgorithm', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_TerminologyCapabilities_codeSystem_version_language(models.Model):
    ...
    class LanguageChoices(models.TextChoices): LANGUAGE_DISPLAYS_SUPPORTED = 'Language Displays supported', 'Language displays supported'; 
...
class FHIR_TerminologyCapabilities_codeSystem_version_filter(models.Model):
    ...
    class CodeChoices(models.TextChoices): CODE_OF_THE_PROPERTY_SUPPORTED = 'Code of the property supported', 'Code of the property supported'; 
...
class FHIR_TerminologyCapabilities_codeSystem_version_filter_op(models.Model):
    ...
    class OpChoices(models.TextChoices): OPERATIONS_SUPPORTED_FOR_THE_PROPERTY = 'Operations supported for the property', 'Operations supported for the property'; 
...
class FHIR_TerminologyCapabilities_codeSystem_version_property(models.Model):
    ...
    class PropertyChoices(models.TextChoices): PROPERTIES_SUPPORTED_FOR_$LOOKUP = 'Properties supported for $lookup', 'Properties supported for $lookup'; 
...
class FHIR_TerminologyCapabilities_expansion_parameter(models.Model):
    ...
    class NameChoices(models.TextChoices): NAME_OF_THE_SUPPORTED_EXPANSION_PARAMETER = 'Name of the supported expansion parameter', 'Name of the supported expansion parameter'; 
