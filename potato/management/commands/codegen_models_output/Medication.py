...
class FHIR_Medication_ingredient(models.Model):
    ...
    item_Substance_ref = models.ForeignKey("FHIR_Substance", related_name="Medication_ingredient_item", null=True, blank=True, on_delete=models.SET_NULL)
    item_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="Medication_ingredient_item", null=True, blank=True, on_delete=models.SET_NULL)
