...
class FHIR_ImagingStudy_procedure(models.Model):
    ...
    procedure_PlanDefinition_ref = models.ForeignKey("FHIR_PlanDefinition", related_name="ImagingStudy_procedure", null=True, blank=True, on_delete=models.SET_NULL)
    procedure_ActivityDefinition_ref = models.ForeignKey("FHIR_ActivityDefinition", related_name="ImagingStudy_procedure", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ImagingStudy_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="ImagingStudy_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="ImagingStudy_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="ImagingStudy_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="ImagingStudy_reason", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ImagingStudy_series(models.Model):
    ...
    bodySite_BodyStructure_ref = models.ForeignKey("FHIR_BodyStructure", related_name="ImagingStudy_series_bodySite", null=True, blank=True, on_delete=models.SET_NULL)
