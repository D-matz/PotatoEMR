...
class FHIR_Immunization(models.Model):
    ...
    administeredProduct_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="Immunization_administeredProduct", null=True, blank=True, on_delete=models.SET_NULL)
    ...
    manufacturer_Organization_ref = models.ForeignKey("FHIR_Organization", related_name="Immunization_manufacturer", null=True, blank=True, on_delete=models.SET_NULL)
    ...
    informationSource_Patient_ref = models.ForeignKey("FHIR_Patient", related_name="Immunization_informationSource", null=True, blank=True, on_delete=models.SET_NULL)
    informationSource_Practitioner_ref = models.ForeignKey("FHIR_Practitioner", related_name="Immunization_informationSource", null=True, blank=True, on_delete=models.SET_NULL)
    informationSource_PractitionerRole_ref = models.ForeignKey("FHIR_PractitionerRole", related_name="Immunization_informationSource", null=True, blank=True, on_delete=models.SET_NULL)
    informationSource_RelatedPerson_ref = models.ForeignKey("FHIR_RelatedPerson", related_name="Immunization_informationSource", null=True, blank=True, on_delete=models.SET_NULL)
    informationSource_Organization_ref = models.ForeignKey("FHIR_Organization", related_name="Immunization_informationSource", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Immunization_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="Immunization_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="Immunization_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="Immunization_reason", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Immunization_reaction(models.Model):
    ...
    manifestation_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="Immunization_reaction_manifestation", null=True, blank=True, on_delete=models.SET_NULL)
