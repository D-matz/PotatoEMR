...
class FHIR_Ingredient_substance(models.Model):
    ...
    code_SubstanceDefinition_ref = models.ForeignKey("FHIR_SubstanceDefinition", related_name="Ingredient_substance_code", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Ingredient_substance_strength_referenceStrength(models.Model):
    ...
    substance_SubstanceDefinition_ref = models.ForeignKey("FHIR_SubstanceDefinition", related_name="Ingredient_substance_strength_referenceStrength_substance", null=True, blank=True, on_delete=models.SET_NULL)
