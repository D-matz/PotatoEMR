...
class FHIR_Subscription(models.Model):
    ...
    class ContenttypeChoices(models.TextChoices): MIME_TYPE_TO_SEND,_OR_OMIT_FOR_NO_PAYLOAD = 'MIME type to send, or omit for no payload', 'Mime type to send, or omit for no payload'; 
