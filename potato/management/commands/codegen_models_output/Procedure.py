...
class FHIR_Procedure_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="Procedure_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="Procedure_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="Procedure_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="Procedure_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="Procedure_reason", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Procedure_outcome(models.Model):
    ...
    outcome_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="Procedure_outcome", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Procedure_complication(models.Model):
    ...
    complication_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="Procedure_complication", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Procedure_followUp(models.Model):
    ...
    followUp_ServiceRequest_ref = models.ForeignKey("FHIR_ServiceRequest", related_name="Procedure_followUp", null=True, blank=True, on_delete=models.SET_NULL)
    followUp_PlanDefinition_ref = models.ForeignKey("FHIR_PlanDefinition", related_name="Procedure_followUp", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Procedure_used(models.Model):
    ...
    used_Device_ref = models.ForeignKey("FHIR_Device", related_name="Procedure_used", null=True, blank=True, on_delete=models.SET_NULL)
    used_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="Procedure_used", null=True, blank=True, on_delete=models.SET_NULL)
    used_Substance_ref = models.ForeignKey("FHIR_Substance", related_name="Procedure_used", null=True, blank=True, on_delete=models.SET_NULL)
    used_BiologicallyDerivedProduct_ref = models.ForeignKey("FHIR_BiologicallyDerivedProduct", related_name="Procedure_used", null=True, blank=True, on_delete=models.SET_NULL)
