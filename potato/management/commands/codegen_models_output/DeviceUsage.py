...
class FHIR_DeviceUsage(models.Model):
    ...
    class StatusChoices(models.TextChoices): ACTIVE = 'active', 'Active'; COMPLETED = 'completed', 'Completed'; NOT_DONE = 'not-done', 'Not-done'; ENTERED_IN_ERROR_+ = 'entered-in-error +', 'Entered-in-error +'; 
    ...
    device_Device_ref = models.ForeignKey("FHIR_Device", related_name="DeviceUsage_device", null=True, blank=True, on_delete=models.SET_NULL)
    device_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="DeviceUsage_device", null=True, blank=True, on_delete=models.SET_NULL)
    ...
    bodySite_BodyStructure_ref = models.ForeignKey("FHIR_BodyStructure", related_name="DeviceUsage_bodySite", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_DeviceUsage_reason(models.Model):
    ...
    reason_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="DeviceUsage_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="DeviceUsage_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="DeviceUsage_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="DeviceUsage_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="DeviceUsage_reason", null=True, blank=True, on_delete=models.SET_NULL)
