...
class FHIR_FamilyMemberHistory_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="FamilyMemberHistory_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="FamilyMemberHistory_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_AllergyIntolerance_ref = models.ForeignKey("FHIR_AllergyIntolerance", related_name="FamilyMemberHistory_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_QuestionnaireResponse_ref = models.ForeignKey("FHIR_QuestionnaireResponse", related_name="FamilyMemberHistory_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="FamilyMemberHistory_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="FamilyMemberHistory_reason", null=True, blank=True, on_delete=models.SET_NULL)
