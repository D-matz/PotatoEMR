...
class FHIR_MedicationStatement(models.Model):
    ...
    medication_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="MedicationStatement_medication", null=True, blank=True, on_delete=models.SET_NULL)
    ...
    effective = models.OneToOneField("FHIR_GP_Period", related_name='MedicationStatement_effective', null=True, blank=True, on_delete=models.SET_NULL)
    effective = models.OneToOneField("FHIR_GP_Timing", related_name='MedicationStatement_effective', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_MedicationStatement_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="MedicationStatement_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="MedicationStatement_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="MedicationStatement_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="MedicationStatement_reason", null=True, blank=True, on_delete=models.SET_NULL)
