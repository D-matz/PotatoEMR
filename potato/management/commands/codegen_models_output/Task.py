...
class FHIR_Task(models.Model):
    ...
    class StatusChoices(models.TextChoices): DRAFT = 'draft', 'Draft'; REQUESTED = 'requested', 'Requested'; RECEIVED = 'received', 'Received'; ACCEPTED = 'accepted', 'Accepted'; + = '+', '+'; 
...
class FHIR_Task_requestedPerformer(models.Model):
    ...
    requestedPerformer_Practitioner_ref = models.ForeignKey("FHIR_Practitioner", related_name="Task_requestedPerformer", null=True, blank=True, on_delete=models.SET_NULL)
    requestedPerformer_PractitionerRole_ref = models.ForeignKey("FHIR_PractitionerRole", related_name="Task_requestedPerformer", null=True, blank=True, on_delete=models.SET_NULL)
    requestedPerformer_Organization_ref = models.ForeignKey("FHIR_Organization", related_name="Task_requestedPerformer", null=True, blank=True, on_delete=models.SET_NULL)
    requestedPerformer_CareTeam_ref = models.ForeignKey("FHIR_CareTeam", related_name="Task_requestedPerformer", null=True, blank=True, on_delete=models.SET_NULL)
    requestedPerformer_HealthcareService_ref = models.ForeignKey("FHIR_HealthcareService", related_name="Task_requestedPerformer", null=True, blank=True, on_delete=models.SET_NULL)
    requestedPerformer_Patient_ref = models.ForeignKey("FHIR_Patient", related_name="Task_requestedPerformer", null=True, blank=True, on_delete=models.SET_NULL)
    requestedPerformer_Device_ref = models.ForeignKey("FHIR_Device", related_name="Task_requestedPerformer", null=True, blank=True, on_delete=models.SET_NULL)
    requestedPerformer_RelatedPerson_ref = models.ForeignKey("FHIR_RelatedPerson", related_name="Task_requestedPerformer", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Task_input(models.Model):
    ...
    class ValueChoices(models.TextChoices): CONTENT_TO_USE_IN_PERFORMING_THE_TASK = 'Content to use in performing the task', 'Content to use in performing the task'; 
    ...
    value = models.OneToOneField("FHIR_GP_Address", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Annotation", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Attachment", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_value = 'TODO'
    value_cc = models.ManyToManyField(FHIR_GP_Coding, limit_choices_to={"codings__binding_rule": BINDING_value}, related_name='Task_input_value', blank=True)
    value_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    value = models.OneToOneField("FHIR_GP_Coding", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_ContactPoint", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Distance", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Duration", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_HumanName", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Identifier", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Money", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Period", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Range", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Ratio", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_SampledData", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Signature", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Timing", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_meta_ExtendedContactDetail", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_SP_Dosage", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_SP_Meta", related_name='Task_input_value', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_Task_output(models.Model):
    ...
    value = FHIR_primitive_BooleanField(null=True, blank=True, )
    value = FHIR_primitive_CanonicalField(null=True, blank=True, )
    class ValueChoices(models.TextChoices): RESULT_OF_OUTPUT = 'Result of output', 'Result of output'; 
    value = FHIR_primitive_CodeField(choices=ValueChoices.choices, null=True, blank=True, )
    value = FHIR_primitive_DateField(null=True, blank=True, )
    value = FHIR_primitive_DateTimeField(null=True, blank=True, )
    value = FHIR_primitive_DecimalField(null=True, blank=True, )
    ...
    value = FHIR_primitive_URLField(null=True, blank=True, )
    value = FHIR_primitive_UUIDField(null=True, blank=True, )
    value = models.OneToOneField("FHIR_GP_Address", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Annotation", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Attachment", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_value = 'TODO'
    value_cc = models.ManyToManyField(FHIR_GP_Coding, limit_choices_to={"codings__binding_rule": BINDING_value}, related_name='Task_output_value', blank=True)
    value_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    value = models.OneToOneField("FHIR_GP_Coding", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_ContactPoint", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Distance", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Duration", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_HumanName", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Identifier", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity_Money", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Period", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Quantity", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Range", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Ratio", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_SampledData", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Signature", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_GP_Timing", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_meta_ExtendedContactDetail", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_SP_Dosage", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
    value = models.OneToOneField("FHIR_SP_Meta", related_name='Task_output_value', null=True, blank=True, on_delete=models.SET_NULL)
