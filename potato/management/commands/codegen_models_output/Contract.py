...
class FHIR_Contract(models.Model):
    ...
    class StatusChoices(models.TextChoices): AMENDED = 'amended', 'Amended'; APPENDED = 'appended', 'Appended'; CANCELLED = 'cancelled', 'Cancelled'; DISPUTED = 'disputed', 'Disputed'; ENTERED_IN_ERROR = 'entered-in-error', 'Entered-in-error'; EXECUTABLE_+ = 'executable +', 'Executable +'; 
...
class FHIR_Contract_contentDefinition(models.Model):
    ...
    class PublicationstatusChoices(models.TextChoices): AMENDED = 'amended', 'Amended'; APPENDED = 'appended', 'Appended'; CANCELLED = 'cancelled', 'Cancelled'; DISPUTED = 'disputed', 'Disputed'; ENTERED_IN_ERROR = 'entered-in-error', 'Entered-in-error'; EXECUTABLE_+ = 'executable +', 'Executable +'; 
...
class FHIR_Contract_term_action_reason(models.Model):
    ...
    reason_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="Contract_term_action_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="Contract_term_action_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="Contract_term_action_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="Contract_term_action_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Questionnaire_ref = models.ForeignKey("FHIR_Questionnaire", related_name="Contract_term_action_reason", null=True, blank=True, on_delete=models.SET_NULL)
    reason_QuestionnaireResponse_ref = models.ForeignKey("FHIR_QuestionnaireResponse", related_name="Contract_term_action_reason", null=True, blank=True, on_delete=models.SET_NULL)
