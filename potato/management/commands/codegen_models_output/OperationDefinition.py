...
class FHIR_OperationDefinition(models.Model):
    ...
    versionAlgorithm = models.OneToOneField("FHIR_GP_Coding", related_name='OperationDefinition_versionAlgorithm', null=True, blank=True, on_delete=models.SET_NULL)
    ...
    class CodeChoices(models.TextChoices): RECOMMENDED_NAME_FOR_OPERATION_IN_SEARCH_URL = 'Recommended name for operation in search url', 'Recommended name for operation in search url'; 
...
class FHIR_OperationDefinition_resource(models.Model):
    ...
    class ResourceChoices(models.TextChoices): TYPES_THIS_OPERATION_APPLIES_TO = 'Types this operation applies to', 'Types this operation applies to'; 
...
class FHIR_OperationDefinition_parameter(models.Model):
    ...
    class NameChoices(models.TextChoices): NAME_IN_PARAMETERS.PARAMETER.NAME_OR_IN_URL = 'Name in Parameters.parameter.name or in URL', 'Name in parameters.parameter.name or in url'; 
    ...
    class TypeChoices(models.TextChoices): WHAT_TYPE_THIS_PARAMETER_HAS = 'What type this parameter has', 'What type this parameter has'; 
...
class FHIR_OperationDefinition_parameter_allowedType(models.Model):
    ...
    class AllowedtypeChoices(models.TextChoices): ALLOWED_SUB_TYPE_THIS_PARAMETER_CAN_HAVE_IF_TYPE_IS_ABSTRACT = 'Allowed sub-type this parameter can have (if type is abstract)', 'Allowed sub-type this parameter can have (if type is abstract)'; 
