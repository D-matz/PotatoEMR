...
class FHIR_MedicationDispense(models.Model):
    ...
    notPerformedReason_DetectedIssue_ref = models.ForeignKey("FHIR_DetectedIssue", related_name="MedicationDispense_notPerformedReason", null=True, blank=True, on_delete=models.SET_NULL)
    ...
    medication_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="MedicationDispense_medication", null=True, blank=True, on_delete=models.SET_NULL)
