...
class FHIR_RegulatedAuthorization_indication(models.Model):
    ...
    indication_ClinicalUseDefinition_ref = models.ForeignKey("FHIR_ClinicalUseDefinition", related_name="RegulatedAuthorization_indication_ClinicalUseDefinition", null=True, blank=True, on_delete=models.SET_NULL)
