...
class FHIR_PlanDefinition_action(models.Model):
    ...
    location_Location_ref = models.ForeignKey("FHIR_Location", related_name="PlanDefinition_action_location_Location", null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_type = 'TODO'
