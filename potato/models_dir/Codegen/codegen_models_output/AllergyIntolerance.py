...
class FHIR_AllergyIntolerance(models.Model):
    ...
    onset_Age = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='AllergyIntolerance_onset_Age', null=True, blank=True, on_delete=models.SET_NULL)
    onset_Period = models.OneToOneField("FHIR_GP_Period", related_name='AllergyIntolerance_onset_Period', null=True, blank=True, on_delete=models.SET_NULL)
    onset_Range = models.OneToOneField("FHIR_GP_Range", related_name='AllergyIntolerance_onset_Range', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_AllergyIntolerance_reaction_manifestation(models.Model):
    ...
    manifestation_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="AllergyIntolerance_reaction_manifestation_Observation", null=True, blank=True, on_delete=models.SET_NULL)
