...
class FHIR_StructureMap_import(models.Model):
    ...
    import_field = FHIR_primitive_CanonicalField(null=True, blank=True, )
...
class FHIR_StructureMap_group_rule_source(models.Model):
    ...
    check_field = FHIR_primitive_StringField(null=True, blank=True, )
...
class FHIR_StructureMap_group_rule_target(models.Model):
    ...
    class TransformChoices(models.TextChoices): CREATE = 'create', 'Create'; COPY_PLUS = 'copy +', 'Copy +'; 
