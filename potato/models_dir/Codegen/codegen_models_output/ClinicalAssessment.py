...
class FHIR_ClinicalAssessment(models.Model):
    ...
    effective_Period = models.OneToOneField("FHIR_GP_Period", related_name='ClinicalAssessment_effective_Period', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ClinicalAssessment_finding(models.Model):
    ...
    item_Condition_ref = models.ForeignKey("FHIR_Condition", related_name="ClinicalAssessment_finding_item_Condition", null=True, blank=True, on_delete=models.SET_NULL)
    item_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="ClinicalAssessment_finding_item_Observation", null=True, blank=True, on_delete=models.SET_NULL)
    item_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="ClinicalAssessment_finding_item_DocumentReference", null=True, blank=True, on_delete=models.SET_NULL)
