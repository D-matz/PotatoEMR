...
class FHIR_ServiceRequest(models.Model):
    ...
    class IntentChoices(models.TextChoices): PROPOSAL = 'proposal', 'Proposal'; PLAN = 'plan', 'Plan'; DIRECTIVE = 'directive', 'Directive'; ORDER_PLUS = 'order +', 'Order +'; 
...
class FHIR_ServiceRequest_orderDetail(models.Model):
    ...
    parameterFocus_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="ServiceRequest_orderDetail_parameterFocus_DeviceDefinition", null=True, blank=True, on_delete=models.SET_NULL)
    parameterFocus_DeviceRequest_ref = models.ForeignKey("FHIR_DeviceRequest", related_name="ServiceRequest_orderDetail_parameterFocus_DeviceRequest", null=True, blank=True, on_delete=models.SET_NULL)
    parameterFocus_SupplyRequest_ref = models.ForeignKey("FHIR_SupplyRequest", related_name="ServiceRequest_orderDetail_parameterFocus_SupplyRequest", null=True, blank=True, on_delete=models.SET_NULL)
    parameterFocus_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="ServiceRequest_orderDetail_parameterFocus_Medication", null=True, blank=True, on_delete=models.SET_NULL)
    parameterFocus_MedicationRequest_ref = models.ForeignKey("FHIR_MedicationRequest", related_name="ServiceRequest_orderDetail_parameterFocus_MedicationRequest", null=True, blank=True, on_delete=models.SET_NULL)
    parameterFocus_BiologicallyDerivedProduct_ref = models.ForeignKey("FHIR_BiologicallyDerivedProduct", related_name="ServiceRequest_orderDetail_parameterFocus_BiologicallyDerivedProduct", null=True, blank=True, on_delete=models.SET_NULL)
    parameterFocus_Substance_ref = models.ForeignKey("FHIR_Substance", related_name="ServiceRequest_orderDetail_parameterFocus_Substance", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ServiceRequest_reason(models.Model):
    ...
    reason_Observation_ref = models.ForeignKey("FHIR_Observation", related_name="ServiceRequest_reason_Observation", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DiagnosticReport_ref = models.ForeignKey("FHIR_DiagnosticReport", related_name="ServiceRequest_reason_DiagnosticReport", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DocumentReference_ref = models.ForeignKey("FHIR_DocumentReference", related_name="ServiceRequest_reason_DocumentReference", null=True, blank=True, on_delete=models.SET_NULL)
    reason_DetectedIssue_ref = models.ForeignKey("FHIR_DetectedIssue", related_name="ServiceRequest_reason_DetectedIssue", null=True, blank=True, on_delete=models.SET_NULL)
    reason_Procedure_ref = models.ForeignKey("FHIR_Procedure", related_name="ServiceRequest_reason_Procedure", null=True, blank=True, on_delete=models.SET_NULL)
