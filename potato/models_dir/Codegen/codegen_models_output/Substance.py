...
class FHIR_Substance(models.Model):
    ...
    code_SubstanceDefinition_ref = models.ForeignKey("FHIR_SubstanceDefinition", related_name="Substance_code_SubstanceDefinition", null=True, blank=True, on_delete=models.SET_NULL)
