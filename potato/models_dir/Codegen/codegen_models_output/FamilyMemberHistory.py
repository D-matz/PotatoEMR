...
class FHIR_FamilyMemberHistory(models.Model):
    ...
    born_Period = models.OneToOneField("FHIR_GP_Period", related_name='FamilyMemberHistory_born_Period', null=True, blank=True, on_delete=models.SET_NULL)
    born_date = FHIR_primitive_DateField(null=True, blank=True, )
    born_string = FHIR_primitive_StringField(null=True, blank=True, )
    age_Age = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='FamilyMemberHistory_age_Age', null=True, blank=True, on_delete=models.SET_NULL)
    age_Range = models.OneToOneField("FHIR_GP_Range", related_name='FamilyMemberHistory_age_Range', null=True, blank=True, on_delete=models.SET_NULL)
    age_string = FHIR_primitive_StringField(null=True, blank=True, )
    ...
    deceased_Age = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='FamilyMemberHistory_deceased_Age', null=True, blank=True, on_delete=models.SET_NULL)
    deceased_Range = models.OneToOneField("FHIR_GP_Range", related_name='FamilyMemberHistory_deceased_Range', null=True, blank=True, on_delete=models.SET_NULL)
    deceased_date = FHIR_primitive_DateField(null=True, blank=True, )
    deceased_string = FHIR_primitive_StringField(null=True, blank=True, )
...
class FHIR_FamilyMemberHistory_condition(models.Model):
    ...
    onset_Age = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='FamilyMemberHistory_condition_onset_Age', null=True, blank=True, on_delete=models.SET_NULL)
    onset_Range = models.OneToOneField("FHIR_GP_Range", related_name='FamilyMemberHistory_condition_onset_Range', null=True, blank=True, on_delete=models.SET_NULL)
    onset_Period = models.OneToOneField("FHIR_GP_Period", related_name='FamilyMemberHistory_condition_onset_Period', null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_FamilyMemberHistory_procedure(models.Model):
    ...
    outcome_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    contributedToDeath = FHIR_primitive_BooleanField(null=True, blank=True, )
    performed_Age = models.OneToOneField("FHIR_GP_Quantity_Age", related_name='FamilyMemberHistory_procedure_performed_Age', null=True, blank=True, on_delete=models.SET_NULL)
    performed_Range = models.OneToOneField("FHIR_GP_Range", related_name='FamilyMemberHistory_procedure_performed_Range', null=True, blank=True, on_delete=models.SET_NULL)
    performed_Period = models.OneToOneField("FHIR_GP_Period", related_name='FamilyMemberHistory_procedure_performed_Period', null=True, blank=True, on_delete=models.SET_NULL)
    performed_string = FHIR_primitive_StringField(null=True, blank=True, )
    performed_dateTime = FHIR_primitive_DateTimeField(null=True, blank=True, )
