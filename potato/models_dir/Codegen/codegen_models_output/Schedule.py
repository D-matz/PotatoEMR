...
class FHIR_Schedule_serviceType(models.Model):
    ...
    serviceType_HealthcareService_ref = models.ForeignKey("FHIR_HealthcareService", related_name="Schedule_serviceType_HealthcareService", null=True, blank=True, on_delete=models.SET_NULL)
