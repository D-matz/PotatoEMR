...
class FHIR_ClinicalUseDefinition_contraindication(models.Model):
    ...
    diseaseSymptomProcedure_ObservationDefinition_ref = models.ForeignKey("FHIR_ObservationDefinition", related_name="ClinicalUseDefinition_contraindication_diseaseSymptomProcedure_ObservationDefinition", null=True, blank=True, on_delete=models.SET_NULL)
    ...
    diseaseStatus_ObservationDefinition_ref = models.ForeignKey("FHIR_ObservationDefinition", related_name="ClinicalUseDefinition_contraindication_diseaseStatus_ObservationDefinition", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ClinicalUseDefinition_contraindication_comorbidity(models.Model):
    ...
    comorbidity_ObservationDefinition_ref = models.ForeignKey("FHIR_ObservationDefinition", related_name="ClinicalUseDefinition_contraindication_comorbidity_ObservationDefinition", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ClinicalUseDefinition_contraindication_otherTherapy(models.Model):
    ...
    treatment_MedicinalProductDefinition_ref = models.ForeignKey("FHIR_MedicinalProductDefinition", related_name="ClinicalUseDefinition_contraindication_otherTherapy_treatment_MedicinalProductDefinition", null=True, blank=True, on_delete=models.SET_NULL)
    treatment_Medication_ref = models.ForeignKey("FHIR_Medication", related_name="ClinicalUseDefinition_contraindication_otherTherapy_treatment_Medication", null=True, blank=True, on_delete=models.SET_NULL)
    treatment_SubstanceDefinition_ref = models.ForeignKey("FHIR_SubstanceDefinition", related_name="ClinicalUseDefinition_contraindication_otherTherapy_treatment_SubstanceDefinition", null=True, blank=True, on_delete=models.SET_NULL)
    treatment_NutritionProduct_ref = models.ForeignKey("FHIR_NutritionProduct", related_name="ClinicalUseDefinition_contraindication_otherTherapy_treatment_NutritionProduct", null=True, blank=True, on_delete=models.SET_NULL)
    treatment_BiologicallyDerivedProduct_ref = models.ForeignKey("FHIR_BiologicallyDerivedProduct", related_name="ClinicalUseDefinition_contraindication_otherTherapy_treatment_BiologicallyDerivedProduct", null=True, blank=True, on_delete=models.SET_NULL)
    treatment_ActivityDefinition_ref = models.ForeignKey("FHIR_ActivityDefinition", related_name="ClinicalUseDefinition_contraindication_otherTherapy_treatment_ActivityDefinition", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ClinicalUseDefinition_indication(models.Model):
    ...
    diseaseSymptomProcedure_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    diseaseSymptomProcedure_ObservationDefinition_ref = models.ForeignKey("FHIR_ObservationDefinition", related_name="ClinicalUseDefinition_indication_diseaseSymptomProcedure_ObservationDefinition", null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_diseaseStatus = "TODO"
    ...
    diseaseStatus_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    diseaseStatus_ObservationDefinition_ref = models.ForeignKey("FHIR_ObservationDefinition", related_name="ClinicalUseDefinition_indication_diseaseStatus_ObservationDefinition", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ClinicalUseDefinition_indication_comorbidity(models.Model):
    ...
    comorbidity_cctext = FHIR_primitive_StringField(max_length=5000, null=True, blank=True)
    comorbidity_ObservationDefinition_ref = models.ForeignKey("FHIR_ObservationDefinition", related_name="ClinicalUseDefinition_indication_comorbidity_ObservationDefinition", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ClinicalUseDefinition_interaction(models.Model):
    ...
    effect_ObservationDefinition_ref = models.ForeignKey("FHIR_ObservationDefinition", related_name="ClinicalUseDefinition_interaction_effect_ObservationDefinition", null=True, blank=True, on_delete=models.SET_NULL)
...
class FHIR_ClinicalUseDefinition_undesirableEffect(models.Model):
    ...
    symptomConditionEffect_ObservationDefinition_ref = models.ForeignKey("FHIR_ObservationDefinition", related_name="ClinicalUseDefinition_undesirableEffect_symptomConditionEffect_ObservationDefinition", null=True, blank=True, on_delete=models.SET_NULL)
