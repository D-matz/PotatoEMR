...
class FHIR_ActorDefinition(models.Model):
    ...
    versionAlgorithm_Coding = models.OneToOneField("FHIR_GP_Coding", related_name='ActorDefinition_versionAlgorithm_Coding', null=True, blank=True, on_delete=models.SET_NULL)
