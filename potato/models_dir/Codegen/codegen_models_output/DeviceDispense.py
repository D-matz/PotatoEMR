...
class FHIR_DeviceDispense(models.Model):
    ...
    statusReason_DetectedIssue_ref = models.ForeignKey("FHIR_DetectedIssue", related_name="DeviceDispense_statusReason_DetectedIssue", null=True, blank=True, on_delete=models.SET_NULL)
    BINDING_device = "TODO"
    ...
    device_Device_ref = models.ForeignKey("FHIR_Device", related_name="DeviceDispense_device_Device", null=True, blank=True, on_delete=models.SET_NULL)
    device_DeviceDefinition_ref = models.ForeignKey("FHIR_DeviceDefinition", related_name="DeviceDispense_device_DeviceDefinition", null=True, blank=True, on_delete=models.SET_NULL)
