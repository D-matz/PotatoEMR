    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servicePeriod', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Account_servicePeriod', to='potato.fhir_gp_period')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor_Location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_participant_actor', to='potato.fhir_location')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patientInstruction_Binary_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_patientInstruction', to='potato.fhir_binary')),
                ('patientInstruction_Communication_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_patientInstruction', to='potato.fhir_communication')),
                ('patientInstruction_DocumentReference_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_patientInstruction', to='potato.fhir_documentreference')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serviceType_HealthcareService_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_serviceType', to='potato.fhir_healthcareservice')),
            ],
        ),
        migrations.AddField(
            model_name='fhir_account',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='Appointment_basedOn', to='potato.fhir_medicationrequest'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='Appointment_basedOn', to='potato.fhir_nutritionorder'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_Condition_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_reason', to='potato.fhir_condition')),
                ('reason_DiagnosticReport_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_reason', to='potato.fhir_diagnosticreport')),
                ...
                ('reason_ImmunizationRecommendation_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_reason', to='potato.fhir_immunizationrecommendation')),
                ('reason_Observation_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_reason', to='potato.fhir_observation')),
                ('reason_Procedure_ref', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Appointment_reason', to='potato.fhir_procedure')),
            ],
        ),
        migrations.AddField(
            model_name='fhir_medicationrequest',
