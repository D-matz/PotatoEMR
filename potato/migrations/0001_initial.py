# Generated by Django 3.2.25 on 2025-01-05 01:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='fhir_patient',
            name='marital_status',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patient_maritalstatus', to='potato.fhir_gp_codeableconcept'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', potato.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_CodeField(max_length=10)),
                ('allergy_intolerance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='potato.fhir_allergyintolerance')),
                ('exposureRoute', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_reaction_exposureroute', to='potato.fhir_gp_codeableconcept')),
                ('manifestation', models.ManyToManyField(to='potato.FHIR_Observation')),
                ('substance', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_reaction_substance', to='potato.fhir_gp_codeableconcept')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergy_intolerance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='potato.fhir_allergyintolerance')),
                ('function', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_participant_function', to='potato.fhir_gp_codeableconcept')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('allergy_intolerance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='potato.fhir_allergyintolerance')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='potato.fhir_gp_codeableconcept')),
            ],
        ),
        migrations.AddField(
            model_name='fhir_allergyintolerance',
            name='category',
            field=models.ManyToManyField(blank=True, related_name='allergyintolerance_category', through='potato.FHIR_AllergyIntolerance_CategoryThrough', to='potato.FHIR_GP_CodeableConcept'),
        ),
        migrations.AddField(
            model_name='fhir_allergyintolerance',
            name='clinical_status',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_clinicalstatus', to='potato.fhir_gp_codeableconcept'),
        ),
        migrations.AddField(
            model_name='fhir_allergyintolerance',
            name='code',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_code', to='potato.fhir_gp_codeableconcept'),
        ),
        migrations.AddField(
            model_name='fhir_allergyintolerance',
            name='criticality',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_criticality', to='potato.fhir_gp_codeableconcept'),
        ),
        migrations.AddField(
            model_name='fhir_allergyintolerance',
            name='encounter',
        ...
        migrations.AddField(
            model_name='fhir_allergyintolerance',
            name='type',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_type', to='potato.fhir_gp_codeableconcept'),
        ),
        migrations.AddField(
            model_name='fhir_allergyintolerance',
            name='verification_status',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_verificationstatus', to='potato.fhir_gp_codeableconcept'),
        ),
        migrations.CreateModel(
