# Generated by Django 3.2.25 on 2024-12-26 17:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('use', potato.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_CodeField(blank=True, max_length=20, null=True)),
                ('text', potato.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_StringField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('general_practitioner_organization', models.ManyToManyField(blank=True, related_name='patients_general_practitioner_organization', to='potato.FHIR_Organization')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_reference', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='potato.fhir_organization')),
        ...
        migrations.CreateModel(
            name='FHIR_SP_Reference',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reference', potato.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_StringField(max_length=99999)),
                ('type', potato.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_URIField(max_length=500)),
                ('display', potato.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_StringField(max_length=8000)),
                ('identifier', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ref_identifier', to='potato.fhir_gp_identifier')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telecom', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patient_telecom', to='potato.fhir_gp_contactpoint')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patient_photo', to='potato.fhir_gp_attachment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='patient_name', to='potato.fhir_gp_humanname')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_patient_foreignKey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='link_other_patient', to='potato.fhir_patient')),
                ('other_reference', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='link_other', to='potato.fhir_sp_reference')),
                ('other_relatedPerson_foreignKey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='link_other_relatedPerson', to='potato.fhir_relatedperson')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identifier', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patient_identifier', to='potato.fhir_gp_identifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telecom', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patient_conctact_telecom', to='potato.fhir_gp_contactpoint')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patient_contact_relationship', to='potato.fhir_gp_codeableconcept')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patient_address', to='potato.fhir_gp_address')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='patients_general_practitioner', to='potato.FHIR_Practitioner'),
        ),
        migrations.AddField(
            model_name='fhir_patient',
            name='general_practitioner_practitionerRole',
            field=models.ManyToManyField(blank=True, related_name='patients_general_practitionerRole', to='potato.FHIR_PractitionerRole'),
        ),
        migrations.AddField(
            model_name='fhir_patient',
            name='general_practitioner_reference',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='patient_generalPractitioner', to='potato.fhir_sp_reference'),
        ),
        migrations.AddField(
            model_name='fhir_patient',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='patient_managingOrganization', to='potato.fhir_sp_reference'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('onBehalfOf_reference', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='onBehalfOf_reference', to='potato.fhir_sp_reference')),
                ...
                ('who_reference', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='who_reference', to='potato.fhir_sp_reference')),
        ...
        migrations.AddField(
            model_name='fhir_gp_identifier',
            name='assigner_reference',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='potato.fhir_sp_reference'),
        ),
        migrations.AddField(
            model_name='fhir_gp_identifier',
            name='period',
        ...
        migrations.AddField(
            model_name='fhir_gp_identifier',
            name='type',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='identifier_type', to='potato.fhir_gp_codeableconcept'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='fhir_gp_contactpoint',
            name='period',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='potato.fhir_gp_period'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='author_reference', to='potato.fhir_sp_reference')),
