    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deceased', potato.models_dir.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_DateTimeField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='FHIR_Procedure',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occurrence', potato.models_dir.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_StringField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('longitude', potato.models_dir.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_DecimalField(blank=True, decimal_places=17, max_digits=18, null=True)),
                ('latitude', potato.models_dir.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_DecimalField(blank=True, decimal_places=17, max_digits=18, null=True)),
                ('altitude', potato.models_dir.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_DecimalField(blank=True, decimal_places=17, max_digits=18, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effective', potato.models_dir.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_InstantField(blank=True, null=True)),
                ...
                ('code_cc', models.ManyToManyField(blank=True, limit_choices_to={'codings__binding_rule': 'TODO'}, related_name='Observation_code', to='potato.fhir_gp_coding')),
                ...
                ('value', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Observation_value', to='potato.fhir_molecularsequence')),
                ('value_cc', models.ManyToManyField(blank=True, limit_choices_to={'codings__binding_rule': 'TODO'}, related_name='Observation_value', to='potato.fhir_gp_coding')),
                ('instantiates', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Observation_instantiates', to='potato.fhir_observationdefinition')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_cc', models.ManyToManyField(blank=True, limit_choices_to={'codings__binding_rule': 'TODO'}, related_name='Observation_component_code', to='potato.fhir_gp_coding')),
                ...
                ('value', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Observation_component_value', to='potato.fhir_molecularsequence')),
                ('value_cc', models.ManyToManyField(blank=True, limit_choices_to={'codings__binding_rule': 'TODO'}, related_name='Observation_component_value', to='potato.fhir_gp_coding')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('multipleBirth', potato.models_dir.FHIR_DataTypes.FHIR_primitive.FHIR_primitive_BooleanField(blank=True, null=True)),
