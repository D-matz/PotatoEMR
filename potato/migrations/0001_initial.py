    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('binding', models.ManyToManyField(related_name='bindings', to='potato.fhir_gp_binding')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exposureRoute_cc', models.ManyToManyField(blank=True, limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-route-codes.html'}, related_name='allergyintolerance_reaction_exposureroute', to='potato.fhir_gp_coding')),
                ('severity', models.ForeignKey(blank=True, limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-reaction-event-severity.html'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='allergyintolerance_reaction_severity', to='potato.fhir_gp_coding')),
                ('substance_cc', models.ManyToManyField(blank=True, limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-substance-code.html'}, related_name='allergyintolerance_reaction_substance', to='potato.fhir_gp_coding')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_cc', models.ManyToManyField(blank=True, limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-timing-abbreviation.html'}, related_name='timing_code_cc', to='potato.fhir_gp_coding')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ManyToManyField(limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-identifier-type.html'}, related_name='identifier_type', to='potato.fhir_gp_coding')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marital_status_cc', models.ManyToManyField(limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-marital-status.html'}, related_name='patient_maritalstatus', to='potato.fhir_gp_coding')),
            ],
        ),
        migrations.AddField(
            model_name='fhir_allergyintolerance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_cc', models.ManyToManyField(limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-languages.html'}, related_name='patient_communication_language', to='potato.fhir_gp_coding')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('function_cc', models.ManyToManyField(limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-participation-role-type.html'}, related_name='allergyintolerance_participant_function', to='potato.fhir_gp_coding')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(blank=True, limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-observation-category.html'}, related_name='observation_category', to='potato.fhir_gp_coding')),
                ('code', models.ManyToManyField(blank=True, limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-observation-codes.html'}, related_name='observation_code', to='potato.fhir_gp_coding')),
