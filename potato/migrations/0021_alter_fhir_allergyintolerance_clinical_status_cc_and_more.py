...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('potato', '0020_remove_fhir_allergyintolerance_clinical_status_cc_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, limit_choices_to={'binding__binding_rule': 'https://www.hl7.org/fhir/valueset-allergy-intolerance-criticality.html'}, to='potato.fhir_gp_coding'),
        ),
    ]
